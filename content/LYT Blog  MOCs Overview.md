---
title  : "LYT Blog | MOCs Overview"
tags   : [webclip]
author : Nick Milo
date   : 2025-12-04
parent : "[[Obsidian praktijktips]]"
---
[Source](https://blog.linkingyourthinking.com/notes/mocs-overview)

This is a brief overview of MOCs. An M—O—C is a cluster of information that maps “things” in context with other “things”. MOC stands for Maps of Content because these notes map the contents of some of your notes.
...
Whenever you start to feel that tickle of overwhelm ([Mental Squeeze Point](https://blog.linkingyourthinking.com/notes/mental-squeeze-point)), that’s when you need to *become a cartographer of your own content* and create a new MOC.
...
8.  MOCs **allow for limitless flexibility**. Unlike folders or Table of Contents (TOC), MOCs are not hierarchical. They are [heterarchical](https://blog.linkingyourthinking.com/notes/heterarchy). This means that different MOCs can map the same info in different ways, to fit whatever your current needs might be.
9.  MOCs **encourage “Relational Positioning”**: Don’t argue with the Ancient Greeks and Romans about the [value of spatial relationships](https://blog.linkingyourthinking.com/notes/method-of-loci). It helps us remember better when ideas are not floating in isolation, but as a part of a spatial constellation.
